...
def upgrade() -> None:
    ...
    op.drop_constraint('certificates_employee_id_fkey', 'certificates', type_='foreignkey')
    ...
    op.create_foreign_key(None, 'exams', 'employees', ['employee_id'], ['id'], ondelete='CASCADE')
    ...
    op.drop_constraint('subdivisions_division_id_fkey', 'subdivisions', type_='foreignkey')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('subdivisions_division_id_fkey', 'subdivisions', 'divisions', ['division_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key('exams_employee_id_fkey', 'exams', 'employees', ['employee_id'], ['id'])
    op.drop_constraint(None, 'exams', type_='unique')
    op.drop_constraint(None, 'employees', type_='foreignkey')
    op.drop_constraint(None, 'employees', type_='foreignkey')
    op.create_foreign_key('employees_subdivision_id_fkey', 'employees', 'subdivisions', ['subdivision_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('employees_position_id_fkey', 'employees', 'positions', ['position_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key('certificates_employee_id_fkey', 'certificates', 'employees', ['employee_id'], ['id'], ondelete='CASCADE')
